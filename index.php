            ...
            <ul class="navbar-nav">
                <li class="nav-item me-3">
                    <form class="d-flex" role="search">
                        ...
                        <button class="btn btn-none halo-effect" type="submit"><i class="fa-solid fa-magnifying-glass fa-beat" style="color: #ffffff;"></i></button>
                    </form>
                </li>
                <li class="nav-item me-3">
                ...
                <li class="nav-item me-3">
                    <a class="nav-link halo-effect" href="#" data-target="text3" style="color : #ffffff">ตำแหน่งที่ตั้ง</a>
                </li>
...
<button onclick="topFunction()" id="backToTopBtn" title="กลับขึ้นด้านบน">⬆</button>
            <br>
            <br>
            ...
            <div class="container text-center">
                <div class="text-end">
                    <a class="icon-link icon-link-hover" style="--bs-link-hover-color-rgb: 255, 72, 240;" href="#">
                        View All
                ...
                <div class="row row-cols-4 row-cols-md- g-1">         
                    ...
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/CPU AMD AM4 RYZEN 7 5700X.png" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/CPU INTEL CORE ULTRA 5 225F LGA 1851.png" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/CPU INTEL CORE ULTRA 7 265 LGA 1851.png" class="card-img-top" alt="...">
                                <div class="card-body">
            ...
            <div class="container text-center">
                ...
                <div class="row row-cols-4 row-cols-md- g-1">         
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/VGA ZOTAC GEFORCE RTX 3060 TWIN EDGE - 12GB GDDR6 [ZT-A30600E-10M] LHR VERSION.png" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/VGA MSI GEFORCE RTX 5060 GAMING TRIO OC - 8GB GDDR7.png" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/VGA ASROCK RADEON RX 9070XT TAICHI OC - 16GB GDDR6.png" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col" id="text1">
                        <div class="card-body" class="text-center" style="color : #000000"> 
                            <div class="card" style="width: 18rem;">
                                <img src="img/VGA GIGABYTE RADEON RX 7700XT GAMING OC - 12GB GDDR6.png" class="card-img-top" alt="...">
                                <div class="card-body">
